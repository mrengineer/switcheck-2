...
(* CORE_GENERATION_INFO = "system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=28,numReposBlks=28,numNonXlnxBlks=17,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=None}" *) (* HW_HANDOFF = "system.hwdef" *) 
module system
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [7:0]gpio_0_m_axis_TDATA;
  wire gpio_0_m_axis_TVALID;
  ...
  system_gpio_0_0 gpio_0
       (.aclk(pll_0_clk_out1),
        ...
        .m_axis_tdata(gpio_0_m_axis_TDATA),
        .m_axis_tvalid(gpio_0_m_axis_TVALID));
  ...
  system_trig_0_0 trig_0
       (.aclk(pll_0_clk_out1),
        .lvl_data(slice_5_dout[7:0]),
        .msk_data(slice_4_dout[7:0]),
        .pol_data(1'b0),
        .s_axis_tdata(gpio_0_m_axis_TDATA),
        .s_axis_tvalid(gpio_0_m_axis_TVALID));
