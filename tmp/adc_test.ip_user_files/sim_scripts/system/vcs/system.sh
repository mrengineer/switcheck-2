...
design_libs=(xilinx_vip xpm xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_15 processing_system7_vip_v1_0_17 xlconstant_v1_1_8 lib_cdc_v1_0_2 proc_sys_reset_v5_0_14)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../bd/system/ip/system_pll_0_0/system_pll_0_0_clk_wiz.v" \
  "../../../bd/system/ip/system_pll_0_0/system_pll_0_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_15 $vlogan_opts -sverilog +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../adc_test.gen/sources_1/bd/system/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_17 $vlogan_opts -sverilog +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xlconstant_v1_1_8 $vlogan_opts +v2k +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bulkin/red-pitaya-notes/tmp/adc_test.cache/compile_simlib/vcs"
  fi
