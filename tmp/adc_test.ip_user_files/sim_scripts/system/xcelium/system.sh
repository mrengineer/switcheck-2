...
#
# Script generated by Vivado on Sun Nov 03 16:49:14 MSK 2024
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_15 -libname processing_system7_vip_v1_0_17 -libname xlconstant_v1_1_8 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_14 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_15 processing_system7_vip_v1_0_17 xlconstant_v1_1_8 lib_cdc_v1_0_2 proc_sys_reset_v5_0_14)
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../bd/system/ip/system_pll_0_0/system_pll_0_0_clk_wiz.v" \
  "../../../bd/system/ip/system_pll_0_0/system_pll_0_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../adc_test.gen/sources_1/bd/system/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_17 $xmvlog_opts -sv +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xlconstant_v1_1_8 $xmvlog_opts +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/c2c6" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../adc_test.gen/sources_1/bd/system/ipshared/6b2b/hdl" +incdir+"/home/bulkin/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bulkin/red-pitaya-notes/tmp/adc_test.cache/compile_simlib/xcelium"
  fi
